...
const ADMIN_APP_URL = import.meta.env.VITE_ADMIN_URL || 'http://localhost:3003';
...
const NAV_SECTIONS: NavSection[] = [
    ...
    },
    {
        title: 'Build',
        items: [
            { icon: Rocket, label: 'Start New Idea', path: '/ideas/new' },
            { icon: Lightbulb, label: 'My Ideas', path: '/my-ideas' },
            { icon: Target, label: 'My Campaigns', path: '/my-campaigns' },
        ]
    },
    {
        title: 'Invest',
    ...
    },
    {
        ...
        items: [
            ...
            { icon: Scale, label: 'Legal & Licenses', path: '/legal' },
        ]
    },
    {
        title: 'Grow',
    ...
    },
    {
        title: 'Admin',
        items: [
            // The admin panel is a separate app (../admin). Set VITE_ADMIN_URL to
            // its deployed origin; defaults to the local dev server on :3003.
            { icon: ShieldCheck, label: 'Admin Panel', path: ADMIN_APP_URL, adminOnly: true, external: true },
        ]
    }
];
