...
import { HeroAppIconField } from '../components/HeroAppIconField';
...
export const HomePage: React.FC = () => {
    ...
    // Real listing artwork fills the hero icon field; the component pads with glyph tiles.
    const heroImages = listings.map(l => l.imageUrl).filter(Boolean).slice(0, 10);
    ...
    return (
        <Layout>
            <div className="-mt-8 -mx-4 md:-mx-6">
                {/* Hero Section - icon field over a dark, vignetted canvas */}
                <section className="relative isolate overflow-hidden bg-[#060608] min-h-[100dvh] flex flex-col items-center justify-center px-6 pb-24 pt-[52vh] md:pt-[56vh]">
                    <HeroAppIconField images={heroImages} />
                    <div className="relative z-10 text-center max-w-[980px] mx-auto space-y-8">
                        <h1
                            className="text-white text-[40px] md:text-[68px] font-semibold leading-[1.05] tracking-[-0.032em] transition-colors duration-300"
